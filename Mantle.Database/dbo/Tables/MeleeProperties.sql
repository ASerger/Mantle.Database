...
ALTER TABLE dbo.MeleeProperties
    ADD CONSTRAINT FK_MeleeProperties_BaseProperty_Id FOREIGN KEY (BasePropertyId) REFERENCES dbo.BaseProperty(Id);
GO

ALTER TABLE dbo.MeleeProperties
    ADD CONSTRAINT FK_MeleeProperties_BaseWeaponCategory_Id FOREIGN KEY (BaseWeaponCategoryId) REFERENCES dbo.BaseWeaponCategory(Id);
GO